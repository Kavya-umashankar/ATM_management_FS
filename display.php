...
cout<<setw(16)<<"Case_ID"<<setw(16)<<"Type"<<setw(16)<<"Name" <<setw(16)<<"Location"
<<setw(16)<<"date"<<setw(16)<<"Time"<<endl;
while(1)
{
// unpack();
...
cout<<setw(10)<<"C_ID"<<setw(10)<<"Address";
for(i=0;i<indsize;i++)
{
